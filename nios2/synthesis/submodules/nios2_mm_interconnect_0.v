...
module nios2_mm_interconnect_0 (
	...
	wire  [96:0] cmd_mux_src_data;                                                          // cmd_mux:src_data -> cpu_debug_mem_slave_agent:cp_data
	wire         cmd_mux_src_ready;                                                         // cpu_debug_mem_slave_agent:cp_ready -> cmd_mux:src_ready
	wire  [11:0] cmd_mux_src_channel;                                                       // cmd_mux:src_channel -> cpu_debug_mem_slave_agent:cp_channel
	...
	wire  [79:0] ram_s1_agent_rf_source_data;                                               // RAM_s1_agent:rf_source_data -> RAM_s1_agent_rsp_fifo:in_data
	...
	wire  [79:0] ram_s1_agent_rsp_fifo_out_data;                                            // RAM_s1_agent_rsp_fifo:out_data -> RAM_s1_agent:rf_sink_data
	...
	wire  [18:0] rom_s1_agent_m0_address;                                                   // ROM_s1_agent:m0_address -> ROM_s1_translator:uav_address
	...
	wire  [79:0] rom_s1_agent_rf_source_data;                                               // ROM_s1_agent:rf_source_data -> ROM_s1_agent_rsp_fifo:in_data
	...
	wire  [79:0] rom_s1_agent_rsp_fifo_out_data;                                            // ROM_s1_agent_rsp_fifo:out_data -> ROM_s1_agent:rf_sink_data
	...
	wire  [96:0] cmd_mux_003_src_data;                                                      // cmd_mux_003:src_data -> switch_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                     // switch_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire  [11:0] cmd_mux_003_src_channel;                                                   // cmd_mux_003:src_channel -> switch_s1_agent:cp_channel
	...
	wire  [96:0] cmd_mux_004_src_data;                                                      // cmd_mux_004:src_data -> led_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                     // led_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire  [11:0] cmd_mux_004_src_channel;                                                   // cmd_mux_004:src_channel -> led_s1_agent:cp_channel
	...
	wire  [18:0] button_s1_agent_m0_address;                                                // button_s1_agent:m0_address -> button_s1_translator:uav_address
	...
	wire  [96:0] cmd_mux_005_src_data;                                                      // cmd_mux_005:src_data -> button_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                     // button_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire  [11:0] cmd_mux_005_src_channel;                                                   // cmd_mux_005:src_channel -> button_s1_agent:cp_channel
	...
	wire  [96:0] cmd_mux_006_src_data;                                                      // cmd_mux_006:src_data -> hex0_s1_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                     // hex0_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire  [11:0] cmd_mux_006_src_channel;                                                   // cmd_mux_006:src_channel -> hex0_s1_agent:cp_channel
	...
	wire  [18:0] hex1_s1_agent_m0_address;                                                  // hex1_s1_agent:m0_address -> hex1_s1_translator:uav_address
	...
	wire  [96:0] cmd_mux_007_src_data;                                                      // cmd_mux_007:src_data -> hex1_s1_agent:cp_data
	wire         cmd_mux_007_src_ready;                                                     // hex1_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire  [11:0] cmd_mux_007_src_channel;                                                   // cmd_mux_007:src_channel -> hex1_s1_agent:cp_channel
	...
	wire  [18:0] hex2_s1_agent_m0_address;                                                  // hex2_s1_agent:m0_address -> hex2_s1_translator:uav_address
	...
	wire  [96:0] cmd_mux_008_src_data;                                                      // cmd_mux_008:src_data -> hex2_s1_agent:cp_data
	wire         cmd_mux_008_src_ready;                                                     // hex2_s1_agent:cp_ready -> cmd_mux_008:src_ready
	wire  [11:0] cmd_mux_008_src_channel;                                                   // cmd_mux_008:src_channel -> hex2_s1_agent:cp_channel
	...
	wire  [18:0] hex3_s1_agent_m0_address;                                                  // hex3_s1_agent:m0_address -> hex3_s1_translator:uav_address
	...
	wire  [97:0] hex3_s1_agent_rf_source_data;                                              // hex3_s1_agent:rf_source_data -> hex3_s1_agent_rsp_fifo:in_data
	...
	wire  [97:0] hex3_s1_agent_rsp_fifo_out_data;                                           // hex3_s1_agent_rsp_fifo:out_data -> hex3_s1_agent:rf_sink_data
	...
	wire  [96:0] cmd_mux_009_src_data;                                                      // cmd_mux_009:src_data -> hex3_s1_agent:cp_data
	wire         cmd_mux_009_src_ready;                                                     // hex3_s1_agent:cp_ready -> cmd_mux_009:src_ready
	wire  [11:0] cmd_mux_009_src_channel;                                                   // cmd_mux_009:src_channel -> hex3_s1_agent:cp_channel
	...
	wire  [18:0] hex5_s1_agent_m0_address;                                                  // hex5_s1_agent:m0_address -> hex5_s1_translator:uav_address
	...
	wire  [97:0] hex5_s1_agent_rf_source_data;                                              // hex5_s1_agent:rf_source_data -> hex5_s1_agent_rsp_fifo:in_data
	...
	wire  [97:0] hex5_s1_agent_rsp_fifo_out_data;                                           // hex5_s1_agent_rsp_fifo:out_data -> hex5_s1_agent:rf_sink_data
	...
	wire         cmd_mux_010_src_valid;                                                     // cmd_mux_010:src_valid -> hex5_s1_agent:cp_valid
	wire  [96:0] cmd_mux_010_src_data;                                                      // cmd_mux_010:src_data -> hex5_s1_agent:cp_data
	wire         cmd_mux_010_src_ready;                                                     // hex5_s1_agent:cp_ready -> cmd_mux_010:src_ready
	wire  [11:0] cmd_mux_010_src_channel;                                                   // cmd_mux_010:src_channel -> hex5_s1_agent:cp_channel
	wire         cmd_mux_010_src_startofpacket;                                             // cmd_mux_010:src_startofpacket -> hex5_s1_agent:cp_startofpacket
	wire         cmd_mux_010_src_endofpacket;                                               // cmd_mux_010:src_endofpacket -> hex5_s1_agent:cp_endofpacket
	...
	wire  [18:0] hex4_s1_agent_m0_address;                                                  // hex4_s1_agent:m0_address -> hex4_s1_translator:uav_address
	...
	wire  [97:0] hex4_s1_agent_rf_source_data;                                              // hex4_s1_agent:rf_source_data -> hex4_s1_agent_rsp_fifo:in_data
	...
	wire  [97:0] hex4_s1_agent_rsp_fifo_out_data;                                           // hex4_s1_agent_rsp_fifo:out_data -> hex4_s1_agent:rf_sink_data
	...
	wire  [96:0] cmd_mux_011_src_data;                                                      // cmd_mux_011:src_data -> hex4_s1_agent:cp_data
	wire         cmd_mux_011_src_ready;                                                     // hex4_s1_agent:cp_ready -> cmd_mux_011:src_ready
	wire  [11:0] cmd_mux_011_src_channel;                                                   // cmd_mux_011:src_channel -> hex4_s1_agent:cp_channel
	...
	wire  [96:0] cpu_debug_mem_slave_agent_rp_data;                                         // cpu_debug_mem_slave_agent:rp_data -> router_002:sink_data
	...
	wire  [78:0] ram_s1_agent_rp_data;                                                      // RAM_s1_agent:rp_data -> router_003:sink_data
	...
	wire         rom_s1_agent_rp_valid;                                                     // ROM_s1_agent:rp_valid -> router_004:sink_valid
	wire  [78:0] rom_s1_agent_rp_data;                                                      // ROM_s1_agent:rp_data -> router_004:sink_data
	wire         rom_s1_agent_rp_ready;                                                     // router_004:sink_ready -> ROM_s1_agent:rp_ready
	wire         rom_s1_agent_rp_startofpacket;                                             // ROM_s1_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire         rom_s1_agent_rp_endofpacket;                                               // ROM_s1_agent:rp_endofpacket -> router_004:sink_endofpacket
	wire         switch_s1_agent_rp_valid;                                                  // switch_s1_agent:rp_valid -> router_005:sink_valid
	wire  [96:0] switch_s1_agent_rp_data;                                                   // switch_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [96:0] led_s1_agent_rp_data;                                                      // led_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [96:0] button_s1_agent_rp_data;                                                   // button_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [96:0] hex0_s1_agent_rp_data;                                                     // hex0_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [96:0] hex1_s1_agent_rp_data;                                                     // hex1_s1_agent:rp_data -> router_009:sink_data
	...
	wire  [96:0] hex2_s1_agent_rp_data;                                                     // hex2_s1_agent:rp_data -> router_010:sink_data
	...
	wire  [96:0] hex3_s1_agent_rp_data;                                                     // hex3_s1_agent:rp_data -> router_011:sink_data
	...
	wire  [96:0] hex5_s1_agent_rp_data;                                                     // hex5_s1_agent:rp_data -> router_012:sink_data
	...
	wire  [96:0] hex4_s1_agent_rp_data;                                                     // hex4_s1_agent:rp_data -> router_013:sink_data
	...
	wire  [78:0] ram_s1_burst_adapter_source0_data;                                         // RAM_s1_burst_adapter:source0_data -> RAM_s1_agent:cp_data
	...
	wire  [78:0] rom_s1_burst_adapter_source0_data;                                         // ROM_s1_burst_adapter:source0_data -> ROM_s1_agent:cp_data
	wire         rom_s1_burst_adapter_source0_ready;                                        // ROM_s1_agent:cp_ready -> ROM_s1_burst_adapter:source0_ready
	wire  [11:0] rom_s1_burst_adapter_source0_channel;                                      // ROM_s1_burst_adapter:source0_channel -> ROM_s1_agent:cp_channel
	...
	wire         router_003_src_valid;                                                      // router_003:src_valid -> RAM_s1_rsp_width_adapter:in_valid
	wire  [78:0] router_003_src_data;                                                       // router_003:src_data -> RAM_s1_rsp_width_adapter:in_data
	wire         router_003_src_ready;                                                      // RAM_s1_rsp_width_adapter:in_ready -> router_003:src_ready
	wire  [11:0] router_003_src_channel;                                                    // router_003:src_channel -> RAM_s1_rsp_width_adapter:in_channel
	wire         router_003_src_startofpacket;                                              // router_003:src_startofpacket -> RAM_s1_rsp_width_adapter:in_startofpacket
	wire         router_003_src_endofpacket;                                                // router_003:src_endofpacket -> RAM_s1_rsp_width_adapter:in_endofpacket
	wire         ram_s1_rsp_width_adapter_src_valid;                                        // RAM_s1_rsp_width_adapter:out_valid -> rsp_demux_001:sink_valid
	wire  [96:0] ram_s1_rsp_width_adapter_src_data;                                         // RAM_s1_rsp_width_adapter:out_data -> rsp_demux_001:sink_data
	wire         ram_s1_rsp_width_adapter_src_ready;                                        // rsp_demux_001:sink_ready -> RAM_s1_rsp_width_adapter:out_ready
	wire  [11:0] ram_s1_rsp_width_adapter_src_channel;                                      // RAM_s1_rsp_width_adapter:out_channel -> rsp_demux_001:sink_channel
	wire         ram_s1_rsp_width_adapter_src_startofpacket;                                // RAM_s1_rsp_width_adapter:out_startofpacket -> rsp_demux_001:sink_startofpacket
	wire         ram_s1_rsp_width_adapter_src_endofpacket;                                  // RAM_s1_rsp_width_adapter:out_endofpacket -> rsp_demux_001:sink_endofpacket
	wire         router_004_src_valid;                                                      // router_004:src_valid -> ROM_s1_rsp_width_adapter:in_valid
	wire  [78:0] router_004_src_data;                                                       // router_004:src_data -> ROM_s1_rsp_width_adapter:in_data
	wire         router_004_src_ready;                                                      // ROM_s1_rsp_width_adapter:in_ready -> router_004:src_ready
	wire  [11:0] router_004_src_channel;                                                    // router_004:src_channel -> ROM_s1_rsp_width_adapter:in_channel
	wire         router_004_src_startofpacket;                                              // router_004:src_startofpacket -> ROM_s1_rsp_width_adapter:in_startofpacket
	wire         router_004_src_endofpacket;                                                // router_004:src_endofpacket -> ROM_s1_rsp_width_adapter:in_endofpacket
	wire         rom_s1_rsp_width_adapter_src_valid;                                        // ROM_s1_rsp_width_adapter:out_valid -> rsp_demux_002:sink_valid
	wire  [96:0] rom_s1_rsp_width_adapter_src_data;                                         // ROM_s1_rsp_width_adapter:out_data -> rsp_demux_002:sink_data
	wire         rom_s1_rsp_width_adapter_src_ready;                                        // rsp_demux_002:sink_ready -> ROM_s1_rsp_width_adapter:out_ready
	wire  [11:0] rom_s1_rsp_width_adapter_src_channel;                                      // ROM_s1_rsp_width_adapter:out_channel -> rsp_demux_002:sink_channel
	wire         rom_s1_rsp_width_adapter_src_startofpacket;                                // ROM_s1_rsp_width_adapter:out_startofpacket -> rsp_demux_002:sink_startofpacket
	wire         rom_s1_rsp_width_adapter_src_endofpacket;                                  // ROM_s1_rsp_width_adapter:out_endofpacket -> rsp_demux_002:sink_endofpacket
	wire         cmd_mux_001_src_valid;                                                     // cmd_mux_001:src_valid -> RAM_s1_cmd_width_adapter:in_valid
	wire  [96:0] cmd_mux_001_src_data;                                                      // cmd_mux_001:src_data -> RAM_s1_cmd_width_adapter:in_data
	wire         cmd_mux_001_src_ready;                                                     // RAM_s1_cmd_width_adapter:in_ready -> cmd_mux_001:src_ready
	wire  [11:0] cmd_mux_001_src_channel;                                                   // cmd_mux_001:src_channel -> RAM_s1_cmd_width_adapter:in_channel
	wire         cmd_mux_001_src_startofpacket;                                             // cmd_mux_001:src_startofpacket -> RAM_s1_cmd_width_adapter:in_startofpacket
	wire         cmd_mux_001_src_endofpacket;                                               // cmd_mux_001:src_endofpacket -> RAM_s1_cmd_width_adapter:in_endofpacket
	wire         ram_s1_cmd_width_adapter_src_valid;                                        // RAM_s1_cmd_width_adapter:out_valid -> RAM_s1_burst_adapter:sink0_valid
	wire  [78:0] ram_s1_cmd_width_adapter_src_data;                                         // RAM_s1_cmd_width_adapter:out_data -> RAM_s1_burst_adapter:sink0_data
	...
	wire         cmd_mux_002_src_valid;                                                     // cmd_mux_002:src_valid -> ROM_s1_cmd_width_adapter:in_valid
	wire  [96:0] cmd_mux_002_src_data;                                                      // cmd_mux_002:src_data -> ROM_s1_cmd_width_adapter:in_data
	wire         cmd_mux_002_src_ready;                                                     // ROM_s1_cmd_width_adapter:in_ready -> cmd_mux_002:src_ready
	wire  [11:0] cmd_mux_002_src_channel;                                                   // cmd_mux_002:src_channel -> ROM_s1_cmd_width_adapter:in_channel
	wire         cmd_mux_002_src_startofpacket;                                             // cmd_mux_002:src_startofpacket -> ROM_s1_cmd_width_adapter:in_startofpacket
	wire         cmd_mux_002_src_endofpacket;                                               // cmd_mux_002:src_endofpacket -> ROM_s1_cmd_width_adapter:in_endofpacket
	wire         rom_s1_cmd_width_adapter_src_valid;                                        // ROM_s1_cmd_width_adapter:out_valid -> ROM_s1_burst_adapter:sink0_valid
	wire  [78:0] rom_s1_cmd_width_adapter_src_data;                                         // ROM_s1_cmd_width_adapter:out_data -> ROM_s1_burst_adapter:sink0_data
	wire         rom_s1_cmd_width_adapter_src_ready;                                        // ROM_s1_burst_adapter:sink0_ready -> ROM_s1_cmd_width_adapter:out_ready
	wire  [11:0] rom_s1_cmd_width_adapter_src_channel;                                      // ROM_s1_cmd_width_adapter:out_channel -> ROM_s1_burst_adapter:sink0_channel
	...
	wire  [17:0] ram_s1_agent_rdata_fifo_src_data;                                          // RAM_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	...
	wire  [17:0] avalon_st_adapter_001_out_0_data;                                          // avalon_st_adapter_001:out_0_data -> RAM_s1_agent:rdata_fifo_sink_data
	...
	wire         rom_s1_agent_rdata_fifo_src_valid;                                         // ROM_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_002:in_0_valid
	wire  [17:0] rom_s1_agent_rdata_fifo_src_data;                                          // ROM_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_002:in_0_data
	wire         rom_s1_agent_rdata_fifo_src_ready;                                         // avalon_st_adapter_002:in_0_ready -> ROM_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_002_out_0_valid;                                         // avalon_st_adapter_002:out_0_valid -> ROM_s1_agent:rdata_fifo_sink_valid
	wire  [17:0] avalon_st_adapter_002_out_0_data;                                          // avalon_st_adapter_002:out_0_data -> ROM_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_002_out_0_ready;                                         // ROM_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire   [0:0] avalon_st_adapter_002_out_0_error;                                         // avalon_st_adapter_002:out_0_error -> ROM_s1_agent:rdata_fifo_sink_error
	...
	wire         hex5_s1_agent_rdata_fifo_src_valid;                                        // hex5_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_010:in_0_valid
	wire  [33:0] hex5_s1_agent_rdata_fifo_src_data;                                         // hex5_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_010:in_0_data
	wire         hex5_s1_agent_rdata_fifo_src_ready;                                        // avalon_st_adapter_010:in_0_ready -> hex5_s1_agent:rdata_fifo_src_ready
	...
	nios2_mm_interconnect_0_router_005 router_006 (
	...
	nios2_mm_interconnect_0_router_005 router_007 (
	...
	nios2_mm_interconnect_0_router_005 router_008 (
	...
	nios2_mm_interconnect_0_router_005 router_009 (
	...
	nios2_mm_interconnect_0_router_005 router_010 (
	...
	nios2_mm_interconnect_0_router_005 router_011 (
	...
	nios2_mm_interconnect_0_router_005 router_012 (
	...
	nios2_mm_interconnect_0_router_005 router_013 (
	...
	nios2_mm_interconnect_0_cmd_mux_002 cmd_mux_004 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_mm_interconnect_0_cmd_mux_002 cmd_mux_005 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_mm_interconnect_0_cmd_mux_002 cmd_mux_006 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_mm_interconnect_0_cmd_mux_002 cmd_mux_007 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_mm_interconnect_0_cmd_mux_002 cmd_mux_008 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_mm_interconnect_0_cmd_mux_002 cmd_mux_009 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_mm_interconnect_0_cmd_mux_002 cmd_mux_010 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_mm_interconnect_0_cmd_mux_002 cmd_mux_011 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_mm_interconnect_0_cmd_demux_001 rsp_demux (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_mm_interconnect_0_rsp_demux_002 rsp_demux_002 (
		.clk                (clk_clk_clk),                                //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset),      // clk_reset.reset
	...
	nios2_mm_interconnect_0_rsp_demux_002 rsp_demux_003 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_mm_interconnect_0_rsp_demux_002 rsp_demux_004 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_mm_interconnect_0_rsp_demux_002 rsp_demux_005 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_mm_interconnect_0_rsp_demux_002 rsp_demux_006 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_mm_interconnect_0_rsp_demux_002 rsp_demux_007 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_mm_interconnect_0_rsp_demux_002 rsp_demux_008 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_mm_interconnect_0_rsp_demux_002 rsp_demux_009 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_mm_interconnect_0_rsp_demux_002 rsp_demux_010 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_mm_interconnect_0_rsp_demux_002 rsp_demux_011 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_mm_interconnect_0_avalon_st_adapter_001 #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
