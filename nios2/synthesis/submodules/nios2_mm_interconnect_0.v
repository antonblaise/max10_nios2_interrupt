...
module nios2_mm_interconnect_0 (
		...
		input  wire        onchip_flash_nreset_reset_bridge_in_reset_reset, // onchip_flash_nreset_reset_bridge_in_reset.reset
		input  wire [22:0] cpu_data_master_address,                         //                           cpu_data_master.address
		...
		input  wire [22:0] cpu_instruction_master_address,                  //                    cpu_instruction_master.address
		...
		output wire [4:0]  ROM_s1_address,                                  //                                    ROM_s1.address
		output wire        ROM_s1_write,                                    //                                          .write
		input  wire [15:0] ROM_s1_readdata,                                 //                                          .readdata
		output wire [15:0] ROM_s1_writedata,                                //                                          .writedata
		output wire [1:0]  ROM_s1_byteenable,                               //                                          .byteenable
	...
	wire   [22:0] cpu_data_master_translator_avalon_universal_master_0_address;              // cpu_data_master_translator:uav_address -> cpu_data_master_agent:av_address
	...
	wire  [103:0] rsp_mux_src_data;                                                          // rsp_mux:src_data -> cpu_data_master_agent:rp_data
	...
	wire   [22:0] cpu_instruction_master_translator_avalon_universal_master_0_address;       // cpu_instruction_master_translator:uav_address -> cpu_instruction_master_agent:av_address
	...
	wire  [103:0] rsp_mux_001_src_data;                                                      // rsp_mux_001:src_data -> cpu_instruction_master_agent:rp_data
	...
	wire   [22:0] onchip_flash_csr_agent_m0_address;                                         // onchip_flash_csr_agent:m0_address -> onchip_flash_csr_translator:uav_address
	...
	wire  [104:0] onchip_flash_csr_agent_rf_source_data;                                     // onchip_flash_csr_agent:rf_source_data -> onchip_flash_csr_agent_rsp_fifo:in_data
	...
	wire  [104:0] onchip_flash_csr_agent_rsp_fifo_out_data;                                  // onchip_flash_csr_agent_rsp_fifo:out_data -> onchip_flash_csr_agent:rf_sink_data
	...
	wire  [103:0] cmd_mux_src_data;                                                          // cmd_mux:src_data -> onchip_flash_csr_agent:cp_data
	wire          cmd_mux_src_ready;                                                         // onchip_flash_csr_agent:cp_ready -> cmd_mux:src_ready
	wire   [13:0] cmd_mux_src_channel;                                                       // cmd_mux:src_channel -> onchip_flash_csr_agent:cp_channel
	...
	wire   [22:0] onchip_flash_data_agent_m0_address;                                        // onchip_flash_data_agent:m0_address -> onchip_flash_data_translator:uav_address
	...
	wire  [104:0] onchip_flash_data_agent_rf_source_data;                                    // onchip_flash_data_agent:rf_source_data -> onchip_flash_data_agent_rsp_fifo:in_data
	...
	wire  [104:0] onchip_flash_data_agent_rsp_fifo_out_data;                                 // onchip_flash_data_agent_rsp_fifo:out_data -> onchip_flash_data_agent:rf_sink_data
	...
	wire  [103:0] cmd_mux_001_src_data;                                                      // cmd_mux_001:src_data -> onchip_flash_data_agent:cp_data
	wire          cmd_mux_001_src_ready;                                                     // onchip_flash_data_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [13:0] cmd_mux_001_src_channel;                                                   // cmd_mux_001:src_channel -> onchip_flash_data_agent:cp_channel
	...
	wire   [22:0] cpu_debug_mem_slave_agent_m0_address;                                      // cpu_debug_mem_slave_agent:m0_address -> cpu_debug_mem_slave_translator:uav_address
	...
	wire   [13:0] cmd_mux_002_src_channel;                                                   // cmd_mux_002:src_channel -> cpu_debug_mem_slave_agent:cp_channel
	...
	wire   [22:0] ram_s1_agent_m0_address;                                                   // RAM_s1_agent:m0_address -> RAM_s1_translator:uav_address
	...
	wire  [104:0] ram_s1_agent_rf_source_data;                                               // RAM_s1_agent:rf_source_data -> RAM_s1_agent_rsp_fifo:in_data
	...
	wire  [104:0] ram_s1_agent_rsp_fifo_out_data;                                            // RAM_s1_agent_rsp_fifo:out_data -> RAM_s1_agent:rf_sink_data
	...
	wire  [103:0] cmd_mux_003_src_data;                                                      // cmd_mux_003:src_data -> RAM_s1_agent:cp_data
	wire          cmd_mux_003_src_ready;                                                     // RAM_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [13:0] cmd_mux_003_src_channel;                                                   // cmd_mux_003:src_channel -> RAM_s1_agent:cp_channel
	...
	wire   [15:0] rom_s1_agent_m0_readdata;                                                  // ROM_s1_translator:uav_readdata -> ROM_s1_agent:m0_readdata
	...
	wire   [22:0] rom_s1_agent_m0_address;                                                   // ROM_s1_agent:m0_address -> ROM_s1_translator:uav_address
	wire    [1:0] rom_s1_agent_m0_byteenable;                                                // ROM_s1_agent:m0_byteenable -> ROM_s1_translator:uav_byteenable
	...
	wire   [15:0] rom_s1_agent_m0_writedata;                                                 // ROM_s1_agent:m0_writedata -> ROM_s1_translator:uav_writedata
	wire          rom_s1_agent_m0_write;                                                     // ROM_s1_agent:m0_write -> ROM_s1_translator:uav_write
	wire    [1:0] rom_s1_agent_m0_burstcount;                                                // ROM_s1_agent:m0_burstcount -> ROM_s1_translator:uav_burstcount
	wire          rom_s1_agent_rf_source_valid;                                              // ROM_s1_agent:rf_source_valid -> ROM_s1_agent_rsp_fifo:in_valid
	wire   [86:0] rom_s1_agent_rf_source_data;                                               // ROM_s1_agent:rf_source_data -> ROM_s1_agent_rsp_fifo:in_data
	...
	wire   [86:0] rom_s1_agent_rsp_fifo_out_data;                                            // ROM_s1_agent_rsp_fifo:out_data -> ROM_s1_agent:rf_sink_data
	...
	wire   [22:0] switch_s1_agent_m0_address;                                                // switch_s1_agent:m0_address -> switch_s1_translator:uav_address
	...
	wire  [103:0] cmd_mux_005_src_data;                                                      // cmd_mux_005:src_data -> switch_s1_agent:cp_data
	wire          cmd_mux_005_src_ready;                                                     // switch_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [13:0] cmd_mux_005_src_channel;                                                   // cmd_mux_005:src_channel -> switch_s1_agent:cp_channel
	...
	wire   [22:0] led_s1_agent_m0_address;                                                   // led_s1_agent:m0_address -> led_s1_translator:uav_address
	...
	wire  [103:0] cmd_mux_006_src_data;                                                      // cmd_mux_006:src_data -> led_s1_agent:cp_data
	wire          cmd_mux_006_src_ready;                                                     // led_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [13:0] cmd_mux_006_src_channel;                                                   // cmd_mux_006:src_channel -> led_s1_agent:cp_channel
	...
	wire   [22:0] button_s1_agent_m0_address;                                                // button_s1_agent:m0_address -> button_s1_translator:uav_address
	...
	wire  [104:0] button_s1_agent_rf_source_data;                                            // button_s1_agent:rf_source_data -> button_s1_agent_rsp_fifo:in_data
	...
	wire  [104:0] button_s1_agent_rsp_fifo_out_data;                                         // button_s1_agent_rsp_fifo:out_data -> button_s1_agent:rf_sink_data
	...
	wire          cmd_mux_007_src_valid;                                                     // cmd_mux_007:src_valid -> button_s1_agent:cp_valid
	wire  [103:0] cmd_mux_007_src_data;                                                      // cmd_mux_007:src_data -> button_s1_agent:cp_data
	wire          cmd_mux_007_src_ready;                                                     // button_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire   [13:0] cmd_mux_007_src_channel;                                                   // cmd_mux_007:src_channel -> button_s1_agent:cp_channel
	...
	wire   [22:0] hex0_s1_agent_m0_address;                                                  // hex0_s1_agent:m0_address -> hex0_s1_translator:uav_address
	...
	wire  [104:0] hex0_s1_agent_rf_source_data;                                              // hex0_s1_agent:rf_source_data -> hex0_s1_agent_rsp_fifo:in_data
	...
	wire  [104:0] hex0_s1_agent_rsp_fifo_out_data;                                           // hex0_s1_agent_rsp_fifo:out_data -> hex0_s1_agent:rf_sink_data
	...
	wire          cmd_mux_008_src_valid;                                                     // cmd_mux_008:src_valid -> hex0_s1_agent:cp_valid
	wire  [103:0] cmd_mux_008_src_data;                                                      // cmd_mux_008:src_data -> hex0_s1_agent:cp_data
	wire          cmd_mux_008_src_ready;                                                     // hex0_s1_agent:cp_ready -> cmd_mux_008:src_ready
	wire   [13:0] cmd_mux_008_src_channel;                                                   // cmd_mux_008:src_channel -> hex0_s1_agent:cp_channel
	wire          cmd_mux_008_src_startofpacket;                                             // cmd_mux_008:src_startofpacket -> hex0_s1_agent:cp_startofpacket
	wire          cmd_mux_008_src_endofpacket;                                               // cmd_mux_008:src_endofpacket -> hex0_s1_agent:cp_endofpacket
	...
	wire   [22:0] hex1_s1_agent_m0_address;                                                  // hex1_s1_agent:m0_address -> hex1_s1_translator:uav_address
	...
	wire  [104:0] hex1_s1_agent_rf_source_data;                                              // hex1_s1_agent:rf_source_data -> hex1_s1_agent_rsp_fifo:in_data
	...
	wire  [104:0] hex1_s1_agent_rsp_fifo_out_data;                                           // hex1_s1_agent_rsp_fifo:out_data -> hex1_s1_agent:rf_sink_data
	...
	wire          cmd_mux_009_src_valid;                                                     // cmd_mux_009:src_valid -> hex1_s1_agent:cp_valid
	wire  [103:0] cmd_mux_009_src_data;                                                      // cmd_mux_009:src_data -> hex1_s1_agent:cp_data
	wire          cmd_mux_009_src_ready;                                                     // hex1_s1_agent:cp_ready -> cmd_mux_009:src_ready
	wire   [13:0] cmd_mux_009_src_channel;                                                   // cmd_mux_009:src_channel -> hex1_s1_agent:cp_channel
	wire          cmd_mux_009_src_startofpacket;                                             // cmd_mux_009:src_startofpacket -> hex1_s1_agent:cp_startofpacket
	wire          cmd_mux_009_src_endofpacket;                                               // cmd_mux_009:src_endofpacket -> hex1_s1_agent:cp_endofpacket
	...
	wire   [22:0] hex2_s1_agent_m0_address;                                                  // hex2_s1_agent:m0_address -> hex2_s1_translator:uav_address
	...
	wire  [104:0] hex2_s1_agent_rf_source_data;                                              // hex2_s1_agent:rf_source_data -> hex2_s1_agent_rsp_fifo:in_data
	...
	wire  [104:0] hex2_s1_agent_rsp_fifo_out_data;                                           // hex2_s1_agent_rsp_fifo:out_data -> hex2_s1_agent:rf_sink_data
	...
	wire  [103:0] cmd_mux_010_src_data;                                                      // cmd_mux_010:src_data -> hex2_s1_agent:cp_data
	wire          cmd_mux_010_src_ready;                                                     // hex2_s1_agent:cp_ready -> cmd_mux_010:src_ready
	wire   [13:0] cmd_mux_010_src_channel;                                                   // cmd_mux_010:src_channel -> hex2_s1_agent:cp_channel
	...
	wire   [22:0] hex3_s1_agent_m0_address;                                                  // hex3_s1_agent:m0_address -> hex3_s1_translator:uav_address
	...
	wire  [104:0] hex3_s1_agent_rf_source_data;                                              // hex3_s1_agent:rf_source_data -> hex3_s1_agent_rsp_fifo:in_data
	...
	wire  [104:0] hex3_s1_agent_rsp_fifo_out_data;                                           // hex3_s1_agent_rsp_fifo:out_data -> hex3_s1_agent:rf_sink_data
	...
	wire          cmd_mux_011_src_valid;                                                     // cmd_mux_011:src_valid -> hex3_s1_agent:cp_valid
	wire  [103:0] cmd_mux_011_src_data;                                                      // cmd_mux_011:src_data -> hex3_s1_agent:cp_data
	wire          cmd_mux_011_src_ready;                                                     // hex3_s1_agent:cp_ready -> cmd_mux_011:src_ready
	wire   [13:0] cmd_mux_011_src_channel;                                                   // cmd_mux_011:src_channel -> hex3_s1_agent:cp_channel
	wire          cmd_mux_011_src_startofpacket;                                             // cmd_mux_011:src_startofpacket -> hex3_s1_agent:cp_startofpacket
	wire          cmd_mux_011_src_endofpacket;                                               // cmd_mux_011:src_endofpacket -> hex3_s1_agent:cp_endofpacket
	...
	wire   [22:0] hex5_s1_agent_m0_address;                                                  // hex5_s1_agent:m0_address -> hex5_s1_translator:uav_address
	...
	wire  [104:0] hex5_s1_agent_rf_source_data;                                              // hex5_s1_agent:rf_source_data -> hex5_s1_agent_rsp_fifo:in_data
	...
	wire  [104:0] hex5_s1_agent_rsp_fifo_out_data;                                           // hex5_s1_agent_rsp_fifo:out_data -> hex5_s1_agent:rf_sink_data
	...
	wire  [103:0] cmd_mux_012_src_data;                                                      // cmd_mux_012:src_data -> hex5_s1_agent:cp_data
	wire          cmd_mux_012_src_ready;                                                     // hex5_s1_agent:cp_ready -> cmd_mux_012:src_ready
	wire   [13:0] cmd_mux_012_src_channel;                                                   // cmd_mux_012:src_channel -> hex5_s1_agent:cp_channel
	...
	wire   [22:0] hex4_s1_agent_m0_address;                                                  // hex4_s1_agent:m0_address -> hex4_s1_translator:uav_address
	...
	wire  [104:0] hex4_s1_agent_rf_source_data;                                              // hex4_s1_agent:rf_source_data -> hex4_s1_agent_rsp_fifo:in_data
	...
	wire  [104:0] hex4_s1_agent_rsp_fifo_out_data;                                           // hex4_s1_agent_rsp_fifo:out_data -> hex4_s1_agent:rf_sink_data
	...
	wire          cmd_mux_013_src_valid;                                                     // cmd_mux_013:src_valid -> hex4_s1_agent:cp_valid
	wire  [103:0] cmd_mux_013_src_data;                                                      // cmd_mux_013:src_data -> hex4_s1_agent:cp_data
	wire          cmd_mux_013_src_ready;                                                     // hex4_s1_agent:cp_ready -> cmd_mux_013:src_ready
	wire   [13:0] cmd_mux_013_src_channel;                                                   // cmd_mux_013:src_channel -> hex4_s1_agent:cp_channel
	wire          cmd_mux_013_src_startofpacket;                                             // cmd_mux_013:src_startofpacket -> hex4_s1_agent:cp_startofpacket
	wire          cmd_mux_013_src_endofpacket;                                               // cmd_mux_013:src_endofpacket -> hex4_s1_agent:cp_endofpacket
	...
	wire          onchip_flash_csr_agent_rp_valid;                                           // onchip_flash_csr_agent:rp_valid -> router_002:sink_valid
	wire  [103:0] onchip_flash_csr_agent_rp_data;                                            // onchip_flash_csr_agent:rp_data -> router_002:sink_data
	wire          onchip_flash_csr_agent_rp_ready;                                           // router_002:sink_ready -> onchip_flash_csr_agent:rp_ready
	wire          onchip_flash_csr_agent_rp_startofpacket;                                   // onchip_flash_csr_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire          onchip_flash_csr_agent_rp_endofpacket;                                     // onchip_flash_csr_agent:rp_endofpacket -> router_002:sink_endofpacket
	...
	wire          onchip_flash_data_agent_rp_valid;                                          // onchip_flash_data_agent:rp_valid -> router_003:sink_valid
	wire  [103:0] onchip_flash_data_agent_rp_data;                                           // onchip_flash_data_agent:rp_data -> router_003:sink_data
	wire          onchip_flash_data_agent_rp_ready;                                          // router_003:sink_ready -> onchip_flash_data_agent:rp_ready
	wire          onchip_flash_data_agent_rp_startofpacket;                                  // onchip_flash_data_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire          onchip_flash_data_agent_rp_endofpacket;                                    // onchip_flash_data_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire  [103:0] ram_s1_agent_rp_data;                                                      // RAM_s1_agent:rp_data -> router_005:sink_data
	...
	wire          rom_s1_agent_rp_valid;                                                     // ROM_s1_agent:rp_valid -> router_006:sink_valid
	wire   [85:0] rom_s1_agent_rp_data;                                                      // ROM_s1_agent:rp_data -> router_006:sink_data
	wire          rom_s1_agent_rp_ready;                                                     // router_006:sink_ready -> ROM_s1_agent:rp_ready
	wire          rom_s1_agent_rp_startofpacket;                                             // ROM_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire          rom_s1_agent_rp_endofpacket;                                               // ROM_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
	wire          switch_s1_agent_rp_valid;                                                  // switch_s1_agent:rp_valid -> router_007:sink_valid
	wire  [103:0] switch_s1_agent_rp_data;                                                   // switch_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [103:0] led_s1_agent_rp_data;                                                      // led_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [103:0] button_s1_agent_rp_data;                                                   // button_s1_agent:rp_data -> router_009:sink_data
	...
	wire          hex0_s1_agent_rp_valid;                                                    // hex0_s1_agent:rp_valid -> router_010:sink_valid
	wire  [103:0] hex0_s1_agent_rp_data;                                                     // hex0_s1_agent:rp_data -> router_010:sink_data
	wire          hex0_s1_agent_rp_ready;                                                    // router_010:sink_ready -> hex0_s1_agent:rp_ready
	wire          hex0_s1_agent_rp_startofpacket;                                            // hex0_s1_agent:rp_startofpacket -> router_010:sink_startofpacket
	wire          hex0_s1_agent_rp_endofpacket;                                              // hex0_s1_agent:rp_endofpacket -> router_010:sink_endofpacket
	...
	wire          hex1_s1_agent_rp_valid;                                                    // hex1_s1_agent:rp_valid -> router_011:sink_valid
	wire  [103:0] hex1_s1_agent_rp_data;                                                     // hex1_s1_agent:rp_data -> router_011:sink_data
	wire          hex1_s1_agent_rp_ready;                                                    // router_011:sink_ready -> hex1_s1_agent:rp_ready
	wire          hex1_s1_agent_rp_startofpacket;                                            // hex1_s1_agent:rp_startofpacket -> router_011:sink_startofpacket
	wire          hex1_s1_agent_rp_endofpacket;                                              // hex1_s1_agent:rp_endofpacket -> router_011:sink_endofpacket
	...
	wire  [103:0] hex2_s1_agent_rp_data;                                                     // hex2_s1_agent:rp_data -> router_012:sink_data
	...
	wire          hex3_s1_agent_rp_valid;                                                    // hex3_s1_agent:rp_valid -> router_013:sink_valid
	wire  [103:0] hex3_s1_agent_rp_data;                                                     // hex3_s1_agent:rp_data -> router_013:sink_data
	wire          hex3_s1_agent_rp_ready;                                                    // router_013:sink_ready -> hex3_s1_agent:rp_ready
	wire          hex3_s1_agent_rp_startofpacket;                                            // hex3_s1_agent:rp_startofpacket -> router_013:sink_startofpacket
	wire          hex3_s1_agent_rp_endofpacket;                                              // hex3_s1_agent:rp_endofpacket -> router_013:sink_endofpacket
	...
	wire  [103:0] hex5_s1_agent_rp_data;                                                     // hex5_s1_agent:rp_data -> router_014:sink_data
	...
	wire          hex4_s1_agent_rp_valid;                                                    // hex4_s1_agent:rp_valid -> router_015:sink_valid
	wire  [103:0] hex4_s1_agent_rp_data;                                                     // hex4_s1_agent:rp_data -> router_015:sink_data
	wire          hex4_s1_agent_rp_ready;                                                    // router_015:sink_ready -> hex4_s1_agent:rp_ready
	wire          hex4_s1_agent_rp_startofpacket;                                            // hex4_s1_agent:rp_startofpacket -> router_015:sink_startofpacket
	wire          hex4_s1_agent_rp_endofpacket;                                              // hex4_s1_agent:rp_endofpacket -> router_015:sink_endofpacket
	wire          router_015_src_valid;                                                      // router_015:src_valid -> rsp_demux_013:sink_valid
	wire  [103:0] router_015_src_data;                                                       // router_015:src_data -> rsp_demux_013:sink_data
	...
	wire   [85:0] rom_s1_burst_adapter_source0_data;                                         // ROM_s1_burst_adapter:source0_data -> ROM_s1_agent:cp_data
	wire          rom_s1_burst_adapter_source0_ready;                                        // ROM_s1_agent:cp_ready -> ROM_s1_burst_adapter:source0_ready
	wire   [13:0] rom_s1_burst_adapter_source0_channel;                                      // ROM_s1_burst_adapter:source0_channel -> ROM_s1_agent:cp_channel
	...
	wire  [103:0] cmd_demux_src13_data;                                                      // cmd_demux:src13_data -> cmd_mux_013:sink0_data
	...
	wire  [103:0] rsp_demux_013_src0_data;                                                   // rsp_demux_013:src0_data -> rsp_mux:sink13_data
	...
	wire          router_006_src_valid;                                                      // router_006:src_valid -> ROM_s1_rsp_width_adapter:in_valid
	wire   [85:0] router_006_src_data;                                                       // router_006:src_data -> ROM_s1_rsp_width_adapter:in_data
	wire          router_006_src_ready;                                                      // ROM_s1_rsp_width_adapter:in_ready -> router_006:src_ready
	wire   [13:0] router_006_src_channel;                                                    // router_006:src_channel -> ROM_s1_rsp_width_adapter:in_channel
	wire          router_006_src_startofpacket;                                              // router_006:src_startofpacket -> ROM_s1_rsp_width_adapter:in_startofpacket
	wire          router_006_src_endofpacket;                                                // router_006:src_endofpacket -> ROM_s1_rsp_width_adapter:in_endofpacket
	wire          rom_s1_rsp_width_adapter_src_valid;                                        // ROM_s1_rsp_width_adapter:out_valid -> rsp_demux_004:sink_valid
	wire  [103:0] rom_s1_rsp_width_adapter_src_data;                                         // ROM_s1_rsp_width_adapter:out_data -> rsp_demux_004:sink_data
	wire          rom_s1_rsp_width_adapter_src_ready;                                        // rsp_demux_004:sink_ready -> ROM_s1_rsp_width_adapter:out_ready
	wire   [13:0] rom_s1_rsp_width_adapter_src_channel;                                      // ROM_s1_rsp_width_adapter:out_channel -> rsp_demux_004:sink_channel
	wire          rom_s1_rsp_width_adapter_src_startofpacket;                                // ROM_s1_rsp_width_adapter:out_startofpacket -> rsp_demux_004:sink_startofpacket
	wire          rom_s1_rsp_width_adapter_src_endofpacket;                                  // ROM_s1_rsp_width_adapter:out_endofpacket -> rsp_demux_004:sink_endofpacket
	wire          cmd_mux_004_src_valid;                                                     // cmd_mux_004:src_valid -> ROM_s1_cmd_width_adapter:in_valid
	wire  [103:0] cmd_mux_004_src_data;                                                      // cmd_mux_004:src_data -> ROM_s1_cmd_width_adapter:in_data
	wire          cmd_mux_004_src_ready;                                                     // ROM_s1_cmd_width_adapter:in_ready -> cmd_mux_004:src_ready
	wire   [13:0] cmd_mux_004_src_channel;                                                   // cmd_mux_004:src_channel -> ROM_s1_cmd_width_adapter:in_channel
	wire          cmd_mux_004_src_startofpacket;                                             // cmd_mux_004:src_startofpacket -> ROM_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_004_src_endofpacket;                                               // cmd_mux_004:src_endofpacket -> ROM_s1_cmd_width_adapter:in_endofpacket
	wire          rom_s1_cmd_width_adapter_src_valid;                                        // ROM_s1_cmd_width_adapter:out_valid -> ROM_s1_burst_adapter:sink0_valid
	wire   [85:0] rom_s1_cmd_width_adapter_src_data;                                         // ROM_s1_cmd_width_adapter:out_data -> ROM_s1_burst_adapter:sink0_data
	wire          rom_s1_cmd_width_adapter_src_ready;                                        // ROM_s1_burst_adapter:sink0_ready -> ROM_s1_cmd_width_adapter:out_ready
	wire   [13:0] rom_s1_cmd_width_adapter_src_channel;                                      // ROM_s1_cmd_width_adapter:out_channel -> ROM_s1_burst_adapter:sink0_channel
	wire          rom_s1_cmd_width_adapter_src_startofpacket;                                // ROM_s1_cmd_width_adapter:out_startofpacket -> ROM_s1_burst_adapter:sink0_startofpacket
	wire          rom_s1_cmd_width_adapter_src_endofpacket;                                  // ROM_s1_cmd_width_adapter:out_endofpacket -> ROM_s1_burst_adapter:sink0_endofpacket
	...
	wire          rom_s1_agent_rdata_fifo_src_valid;                                         // ROM_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire   [17:0] rom_s1_agent_rdata_fifo_src_data;                                          // ROM_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire          rom_s1_agent_rdata_fifo_src_ready;                                         // avalon_st_adapter_004:in_0_ready -> ROM_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_004_out_0_valid;                                         // avalon_st_adapter_004:out_0_valid -> ROM_s1_agent:rdata_fifo_sink_valid
	wire   [17:0] avalon_st_adapter_004_out_0_data;                                          // avalon_st_adapter_004:out_0_data -> ROM_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_004_out_0_ready;                                         // ROM_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire    [0:0] avalon_st_adapter_004_out_0_error;                                         // avalon_st_adapter_004:out_0_error -> ROM_s1_agent:rdata_fifo_sink_error
	...
	wire          button_s1_agent_rdata_fifo_src_valid;                                      // button_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_007:in_0_valid
	wire   [33:0] button_s1_agent_rdata_fifo_src_data;                                       // button_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_007:in_0_data
	wire          button_s1_agent_rdata_fifo_src_ready;                                      // avalon_st_adapter_007:in_0_ready -> button_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_007_out_0_valid;                                         // avalon_st_adapter_007:out_0_valid -> button_s1_agent:rdata_fifo_sink_valid
	...
	wire          hex0_s1_agent_rdata_fifo_src_valid;                                        // hex0_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_008:in_0_valid
	wire   [33:0] hex0_s1_agent_rdata_fifo_src_data;                                         // hex0_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_008:in_0_data
	wire          hex0_s1_agent_rdata_fifo_src_ready;                                        // avalon_st_adapter_008:in_0_ready -> hex0_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_008_out_0_valid;                                         // avalon_st_adapter_008:out_0_valid -> hex0_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_008_out_0_data;                                          // avalon_st_adapter_008:out_0_data -> hex0_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_008_out_0_ready;                                         // hex0_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_008:out_0_ready
	wire    [0:0] avalon_st_adapter_008_out_0_error;                                         // avalon_st_adapter_008:out_0_error -> hex0_s1_agent:rdata_fifo_sink_error
	wire          hex1_s1_agent_rdata_fifo_src_valid;                                        // hex1_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_009:in_0_valid
	wire   [33:0] hex1_s1_agent_rdata_fifo_src_data;                                         // hex1_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_009:in_0_data
	wire          hex1_s1_agent_rdata_fifo_src_ready;                                        // avalon_st_adapter_009:in_0_ready -> hex1_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_009_out_0_valid;                                         // avalon_st_adapter_009:out_0_valid -> hex1_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_009_out_0_data;                                          // avalon_st_adapter_009:out_0_data -> hex1_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_009_out_0_ready;                                         // hex1_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_009:out_0_ready
	wire    [0:0] avalon_st_adapter_009_out_0_error;                                         // avalon_st_adapter_009:out_0_error -> hex1_s1_agent:rdata_fifo_sink_error
	...
	wire          hex3_s1_agent_rdata_fifo_src_valid;                                        // hex3_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_011:in_0_valid
	wire   [33:0] hex3_s1_agent_rdata_fifo_src_data;                                         // hex3_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_011:in_0_data
	wire          hex3_s1_agent_rdata_fifo_src_ready;                                        // avalon_st_adapter_011:in_0_ready -> hex3_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_011_out_0_valid;                                         // avalon_st_adapter_011:out_0_valid -> hex3_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_011_out_0_data;                                          // avalon_st_adapter_011:out_0_data -> hex3_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_011_out_0_ready;                                         // hex3_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_011:out_0_ready
	wire    [0:0] avalon_st_adapter_011_out_0_error;                                         // avalon_st_adapter_011:out_0_error -> hex3_s1_agent:rdata_fifo_sink_error
	...
	wire          hex4_s1_agent_rdata_fifo_src_valid;                                        // hex4_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_013:in_0_valid
	wire   [33:0] hex4_s1_agent_rdata_fifo_src_data;                                         // hex4_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_013:in_0_data
	wire          hex4_s1_agent_rdata_fifo_src_ready;                                        // avalon_st_adapter_013:in_0_ready -> hex4_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_013_out_0_valid;                                         // avalon_st_adapter_013:out_0_valid -> hex4_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_013_out_0_data;                                          // avalon_st_adapter_013:out_0_data -> hex4_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_013_out_0_ready;                                         // hex4_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_013:out_0_ready
	wire    [0:0] avalon_st_adapter_013_out_0_error;                                         // avalon_st_adapter_013:out_0_error -> hex4_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_clk_clk),                                     //                      clk.clk
		.reset                  (onchip_flash_nreset_reset_bridge_in_reset_reset), //                    reset.reset
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_clk_clk),                                       //             clk.clk
		.reset                   (onchip_flash_nreset_reset_bridge_in_reset_reset),   //       clk_reset.reset
	...
	nios2_mm_interconnect_0_router_006 router_006 (
	...
	nios2_mm_interconnect_0_router_007 router_008 (
	...
	nios2_mm_interconnect_0_router_007 router_009 (
	...
	nios2_mm_interconnect_0_router_007 router_010 (
	...
	nios2_mm_interconnect_0_router_007 router_011 (
	...
	nios2_mm_interconnect_0_router_007 router_012 (
	...
	nios2_mm_interconnect_0_router_007 router_013 (
	...
	nios2_mm_interconnect_0_router_007 router_014 (
	...
	nios2_mm_interconnect_0_router_007 router_015 (
	...
	altera_merlin_burst_adapter #(
		...
		.sink0_valid           (rom_s1_cmd_width_adapter_src_valid),         //     sink0.valid
		.sink0_data            (rom_s1_cmd_width_adapter_src_data),          //          .data
		.sink0_channel         (rom_s1_cmd_width_adapter_src_channel),       //          .channel
		.sink0_startofpacket   (rom_s1_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.sink0_endofpacket     (rom_s1_cmd_width_adapter_src_endofpacket),   //          .endofpacket
		.sink0_ready           (rom_s1_cmd_width_adapter_src_ready),         //          .ready
	...
	nios2_mm_interconnect_0_cmd_mux_004 cmd_mux_004 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_mm_interconnect_0_cmd_mux_004 cmd_mux_005 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_mm_interconnect_0_cmd_mux_004 cmd_mux_006 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_mm_interconnect_0_cmd_mux_004 cmd_mux_007 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_mm_interconnect_0_cmd_mux_004 cmd_mux_008 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_mm_interconnect_0_cmd_mux_004 cmd_mux_009 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_mm_interconnect_0_cmd_mux_004 cmd_mux_010 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_mm_interconnect_0_cmd_mux_004 cmd_mux_011 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_mm_interconnect_0_cmd_mux_004 cmd_mux_012 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_mm_interconnect_0_cmd_mux_004 cmd_mux_013 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_mm_interconnect_0_rsp_demux_004 rsp_demux_004 (
		.clk                (clk_clk_clk),                                //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset),      // clk_reset.reset
		.sink_ready         (rom_s1_rsp_width_adapter_src_ready),         //      sink.ready
		.sink_channel       (rom_s1_rsp_width_adapter_src_channel),       //          .channel
		.sink_data          (rom_s1_rsp_width_adapter_src_data),          //          .data
		.sink_startofpacket (rom_s1_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.sink_endofpacket   (rom_s1_rsp_width_adapter_src_endofpacket),   //          .endofpacket
		.sink_valid         (rom_s1_rsp_width_adapter_src_valid),         //          .valid
	...
	nios2_mm_interconnect_0_rsp_demux_004 rsp_demux_005 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_mm_interconnect_0_rsp_demux_004 rsp_demux_006 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_mm_interconnect_0_rsp_demux_004 rsp_demux_007 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_mm_interconnect_0_rsp_demux_004 rsp_demux_008 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_mm_interconnect_0_rsp_demux_004 rsp_demux_009 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_mm_interconnect_0_rsp_demux_004 rsp_demux_010 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_mm_interconnect_0_rsp_demux_004 rsp_demux_011 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_mm_interconnect_0_rsp_demux_004 rsp_demux_012 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2_mm_interconnect_0_rsp_demux_004 rsp_demux_013 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_merlin_width_adapter #(
		...
		.out_endofpacket      (rom_s1_rsp_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (rom_s1_rsp_width_adapter_src_data),          //          .data
		.out_channel          (rom_s1_rsp_width_adapter_src_channel),       //          .channel
		.out_valid            (rom_s1_rsp_width_adapter_src_valid),         //          .valid
		.out_ready            (rom_s1_rsp_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (rom_s1_rsp_width_adapter_src_startofpacket), //          .startofpacket
	...
	altera_merlin_width_adapter #(
		...
		.out_endofpacket      (rom_s1_cmd_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (rom_s1_cmd_width_adapter_src_data),          //          .data
		.out_channel          (rom_s1_cmd_width_adapter_src_channel),       //          .channel
		.out_valid            (rom_s1_cmd_width_adapter_src_valid),         //          .valid
		.out_ready            (rom_s1_cmd_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (rom_s1_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                      // (terminated)
	);
	...
	nios2_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_rst_0_reset (onchip_flash_nreset_reset_bridge_in_reset_reset), // in_rst_0.reset
	...
	nios2_mm_interconnect_0_avalon_st_adapter_004 #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
